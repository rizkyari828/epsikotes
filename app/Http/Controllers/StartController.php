    ...
    public function proceedTestResults($schedule_id)
    {
        ...
        foreach ($job_profiles as $job_profile_seq => $job_profile) {
            ...
            $data = [
                ...
                'memori' => $nilai_6,
                'achieve_total_score' =>$total_score,
                'sim_id' => $schedule_history['CREATED_BY'],
                'tanggal_test' => $schedule_history['ACTUAL_START_DATE'],
                'id_cabang' => $cabang_id,
            ];
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => "https://testing.gawe.id/api/epsikotes/psycotest_result",
