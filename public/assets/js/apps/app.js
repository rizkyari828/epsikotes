 ...
 * LOAD DYNAMIC DIALOG
 */ 
 	function drawDialogConfirm(obj,param,dialog_type) {

 		$('.message_dialog').html(param['message']);
 		 ...
 		 $('#dialog_simple').dialog({
            ...
            resizable : false,
            modal : true,
            title : "<div class='widget-header'><h4><i class='fa fa-warning'></i> "+param['title']+" </h4></div>",
            buttons : [{
                html : "<i class='fa fa-check'></i>&nbsp; Ok",
                "class" : "btn btn-success",
                click : function() {

                	if(dialog_type === 'find_all'){
                    	console.log(obj.ajax.params());
                    	obj.ajax.reload();
                	}else if(dialog_type === 'submit_form'){
                		obj.submit();
                	}
