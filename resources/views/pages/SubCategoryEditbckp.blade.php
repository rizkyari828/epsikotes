                        ...
                        <fieldset>
                            ...
                            <div class="col-xs-12 col-md-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input id="names" name="subCateName" class="form-control" placeholder="Sub Category Name" type="text" list="subCatName" autocomplete="off" value="{{$getSubCat->SUB_CATEGORY_NAME}}">
                                ...
                                <input type="hidden" name="subCatId" id="subCateId" value="{{$getSubCat->SUB_CATEGORY_ID}}">
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Description *</label>
                                    <div class="col-md-10">
                                        <textarea class="form-control" name="subCateDescs" id="subCateDesc" rows="4" required >{{$getSubCat->DESCRIPTION}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="ckeditor" id="workInst" required>{!!$getSubCat->WORK_INSTRUCTION!!}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="checkbox" name="subCateRandom" data-toggle="toggle" data-style="success"{{$checked}}>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" id="Version">
                                            ...
                                            @foreach($getVersionNumber as $key => $value)
                                                <option value="{{$value->VERSION_ID}}" <?php if($getSubCat->VERSION_NUMBER == $value->VERSION_NUMBER) echo "selected"; ?>>{{$value->VERSION_NUMBER}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input type="text" name="mydate" placeholder="Select a date" class="form-control" value="{{$getSubCat->DATE_FROM}}" id="effectiveStartDate">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input type="text" name="mydate2" placeholder="Select a date" class="form-control" disabled="true" value="{{$getSubCat->DATE_TO}}" id="effectiveEndDate">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                        </div>
                                ...
                                <div id="wizards">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <label style="color: red; display: none;" id="errorTypeSubCategory">Type of Sub Category Must be Filled</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <label style="color: red; display: none;" id="errorDuration">Duration must be filled</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="inline-group">
                                            ...
                                            <div class="col-md-6">
                                                <textarea class="form-control" rows="4" id="txtareaHint" disabled="true"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="input-icon-left">
                                                        <input class="form-control" placeholder="Narration Name" id="narName" type="text" list="narations">
                                    ...
                                    <div class="form-group">
                                        <div class="inline-group">
                                            ...
                                            <label class="col-md-1 control-label">Text</label>
                                            <div class="col-md-6">
                                                    <textarea class="form-control" rows="4" id="txtAreaQue" disabled="true"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group" id="typeOfAnswer">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <label style="color: red; display: none;" id="errorTypeAnswer">Type of Answer Must be Filled</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<?php
    ...
    foreach ($getQuestions as $key => $value) {
        ...
        $formQue2[$key][6] = $value->NARRATION_NAME;
             ...
             function getValFormQuestion(){
                ...
                if(j == 'MULTIPLE_CHOICE'){
                    ...
                    if(length > 0){
                        ...
                        arrIndex.sort(function(a, b){return b-a});
