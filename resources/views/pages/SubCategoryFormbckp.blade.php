    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <fieldset>
                            ...
                            <div class="col-xs-12 col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <textarea class="form-control" name="subCateDescs" id="subCateDesc" rows="4" required></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="ckeditor" id="workInst" required></textarea>
                            ...
                            <div class="col-xs-6 col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input type="text" name="mydate2" placeholder="Select a date" class="form-control" value="{{$arrDate['to']}}" id="effectiveEndDate">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                        </div>
                        ...
                        <fieldset>
                                ...
                                <div id="wizards">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="input-icon-left">
                                                        <input class="form-control" placeholder="Narration Name" id="narName" type="text" list="narations" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="checkbox" id="randomCha" disabled="true">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Question Character</label>
                                        <div class="col-lg-2">
                                            <input class="form-control" placeholder="0" id="queCharacter" type="number" disabled="true">
                                        </div>
                                    </div>
                                    <div class="form-group" id="typeOfAnswer">
                                        <label class="col-md-2 control-label">Type Of Answer *</label>
                                        <div class="col-md-8">
                                            <select class="form-control" id="listTypeOfAnswer" disabled="true">
                                                <option value="-">- Select -</option>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                var formQue = Array();
                var ansMultipleChoice = Array();
                var ansTextSeries = Array();
                var ansMultipleGroup = Array();
            ...
            $("#listSubCat").change(function(){
                ...
                if(listSubCat == 'MEMORY'){
                    ...
                    document.getElementById("listTypeOfAnswer").value = 'MEMORY';
            ...
            if(indexQue < 1)
             ...
             function validateQuestion(){
                ...
                if(a == '-'){
                    ...
                    // if(j == 'MULTIPLE_CHOICE' && ansMultipleChoice.length < 1 || j == 'TEXT_SERIES'  && ansTextSeries.length < 1 || j == 'MULTIPLE_GROUP'  && ansMultipleGroup.length < 1){
