                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-6">
                                        <label class="label col col-2">Password</label>
                                            <div class="col col-8">
                                                 <label class="input {{$disableState}}"> <i toggle="#password" class="icon-append fa fa-eye field-icon toggle-password"></i>
                                            <input type="Password" name="PASSWORD" id="password" value="{{$valeInput['PASSWORD']}}" placeholder="Password" {{$isReadOnly}}>
                                        </label>
                                            </div>
                                    </section>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-6">
                                        <label class="label col col-2">Confirm Password</label>
                                            <div class="col col-8">
                                                <label class="input {{$disableState}}"> <i toggle="#CONFIRM_PASSWORD" class="icon-append fa fa-eye field-icon toggle-password"></i>
                                                    <input type="Password"  name="CONFIRM_PASSWORD" value="{{$valeInput['CONFIRM_PASSWORD']}}" id="CONFIRM_PASSWORD" placeholder="Confirm Password" {{$isReadOnly}}>
                                                </label>
                                            </div>
                                    </section>
                                </div>
